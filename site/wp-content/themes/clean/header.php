                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="navbar-header">
                        ...
                        <a href="#" class="js-fh5co-nav-toggle fh5co-nav-toggle visible-xs-block" data-toggle="collapse" data-target="#fh5co-navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
												...
												<!-- echo home_url указывает сылку на домашнюю страницу -->
												<!-- bloginfo('name') название сайта которое мы укажем в админке -->

                    </div>
                    <div id="fh5co-navbar" class="navbar-collapse collapse">

												<!-- Регистрируем меню, оно уже есть по умолчанию в файле function.php -->
												<?php
												wp_nav_menu( array(
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h1 class="intro-lead">
                        ...
                        <?php endif; ?>
                        <!-- Условие при котором при переходе на новые страницы у которых есть заголовок
                        этот заголовок будет динамически выводится на страницу -->
                    </h1>
